...
- [Camunda 8: CPT get-started](https://docs.camunda.io/docs/apis-tools/testing/getting-started/)
- [Camunda 8: CPT JSON test cases](https://docs.camunda.io/docs/apis-tools/testing/json-test-cases/)
